...
- [ ] Performance
    - [ ] Add module-level side-effect import of the PDF-to-JPG client module in PDF tool routes (start `@acajoo/giovanni-pdf-render` / `pdfjs-dist` download at chunk parse time, not on component mount)
