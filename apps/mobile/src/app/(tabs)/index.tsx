...
export default function ScanScreen() {
    ...
    const [maxProcessingLongEdge, setMaxProcessingLongEdgeState] = useState<ProcessingLongEdge | null>(null);

    const bottomInset = insets.bottom + BottomTabInset;

    const canCapture = useMemo(() => hasPermission && device && !isProcessing && Platform.OS !== "web", [device, hasPermission, isProcessing]);
    ...
    async function handleProcessingLongEdgeChange(value: ProcessingLongEdge) {
        ...
        try {
            ...
            setError(settingsError instanceof Error ? settingsError.message : "Could not save map resolution preference.");
        }
    }
    ...
    async function handleModelChange(modelId: DocScannerModelId) {
        ...
        try {
            ...
            setError(settingsError instanceof Error ? settingsError.message : "Could not save model preference.");
        }
    }
        ...
        <View style={styles.screen}>
                ...
                <View style={styles.previewAspect}>
                    {hasPermission && device ? (
                        ...
                        <View style={styles.cameraFallback}>
                            ...
                            <Text style={styles.cameraFallbackText}>Allow camera access, or import a photo from your library.</Text>
                        </View>
                    )}
                    <DocumentScanFrame />
                </View>
            ...
            <View style={[styles.bottomBar, { paddingBottom: bottomInset }]}>
                <Pressable
                    ...
                    style={({ pressed }) => [styles.sideButton, isProcessing && styles.sideButtonDisabled, pressed && !isProcessing && styles.iconButtonPressed]}
                >
                    {Platform.OS === "ios" ? (
                ...
                <Pressable
                    ...
                    style={({ pressed }) => [styles.shutterOuter, !canCapture && styles.shutterDisabled, pressed && canCapture && styles.shutterPressed]}
                >
