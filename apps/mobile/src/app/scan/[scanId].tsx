            ...
            <SafeAreaView style={styles.safeArea}>
                <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                    <View style={styles.header}>
                        ...
                        <StatusPill label={scan.status} tone={scan.status === "fallback" ? "warning" : "ready"} />
                    </View>

                    <BeforeAfterSlider beforeUri={scan.originalUri} afterUri={scan.rectifiedUri} aspectRatio={resolveImageAspectRatio(scan.width, scan.height)} />
                    ...
                    <View style={styles.panel}>
                        ...
                        <Text style={styles.detail}>Model: {isDocScannerModelId(scan.modelVersion) ? getDocScannerModelOption(scan.modelVersion).label : scan.modelVersion}</Text>
                        {scan.width && scan.height ? (
                            <Text style={styles.detail}>
                                Image: {scan.width} x {scan.height}
                            </Text>
                        ) : null}
