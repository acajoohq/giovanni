          ...
          <section className="tab-panel">
            ...
            <div className="options">
              ...
              <label className="option-group">
                ...
                <select
                  value={decodeLevel}
                  onChange={(event) => setDecodeLevel(event.target.value as DecodeLevel)}
                >
              ...
              <div className="option-group">
                ...
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    checked={isRecompressFlateEnabled}
                    onChange={(event) => setIsRecompressFlateEnabled(event.target.checked)}
                  />
                ...
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    checked={isCompressPagesEnabled}
                    onChange={(event) => setIsCompressPagesEnabled(event.target.checked)}
                  />
                  Compress pages
                </label>
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    checked={isRemoveUnreferencedEnabled}
                    onChange={(event) => setIsRemoveUnreferencedEnabled(event.target.checked)}
                  />
              ...
              <div className="results">
                ...
                <div className="stats">
                  ...
                  <Stat
                    ...
                    value={formatBytes(compressionStats.compressedSize)}
                  />
                ...
                <button
                  className="button"
                  type="button"
                  onClick={() => downloadData(compressionStats.compressedData, "compressed.pdf")}
                >
            ...
            {splitPagesData.length > 0 && (
              <div className="split-results">
                <div className="split-header">
                  <h2>
                    {splitPagesData.length} {splitPagesData.length === 1 ? "page" : "pages"}{" "}
                    extracted
                  </h2>
                  <button
                  ...
                  {splitPagesData.map((page) => (
                    <div className="page-item" key={page.fileName}>
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() => downloadData(page.data, page.fileName)}
                      >
                        Download
                      </button>
                    </div>
...
const StatusNotice = ({ status }: { status: StatusMessage }) => (
