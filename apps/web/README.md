...
Preview uses `@giovanni/pdf-render/pdfjs/browser`, which selects the standard or polyfill pdf.js build at runtime. See [`packages/pdfly-pdf-render/README.md`](../../packages/pdfly-pdf-render/README.md).
