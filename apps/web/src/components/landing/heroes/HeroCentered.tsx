...
/** Centered, symmetric composition. Calm and balanced. */
export function HeroCentered({ locale, onStart, variant = "overlay" }: HeroLayoutProps) {
    ...
    return (
        <div className={cn(heroRootClass(isOverlay), "flex flex-col items-center justify-center text-center")}>
            ...
            <div className="relative flex w-full max-w-xl flex-col items-center">
                ...
                <HeroToolChips align="center" className="mt-11" locale={locale} />
            </div>
        </div>
    );
}
