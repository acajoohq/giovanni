...
export function EmptyExtractImages() {
    return (
        <>
            <div className="absolute size-20 rounded-2xl border border-neutral-300 bg-neutral-200 shadow-[0_14px_30px_rgba(0,0,0,0.12)] transition-transform duration-500 group-hover:rotate-3 dark:border-app-border-strong dark:bg-app-surface dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_14px_30px_rgba(0,0,0,0.35)]" />
