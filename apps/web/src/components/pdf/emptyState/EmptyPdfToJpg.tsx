...
export function EmptyPdfToJpg() {
    return (
        <>
            <div className="absolute h-24 w-18 -rotate-6 rounded-xl border border-neutral-300 bg-neutral-200 shadow-[0_14px_30px_rgba(0,0,0,0.15)] transition-transform duration-500 group-hover:-translate-x-2 group-hover:-rotate-12 dark:border-app-border-strong dark:bg-app-surface dark:shadow-[0_14px_30px_rgba(0,0,0,0.35)]" />
