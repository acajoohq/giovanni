export const en = {
    ...
    watermark: {
        ...
        emptyDescription: "Add a watermark PDF page over or under the document.",
        sidebar: {
            files: "Files",
            source: "Source PDF",
        ...
        status: {
            ...
            applied_one: "Watermark applied to {{count}} page.",
            applied_other: "Watermark applied to {{count}} pages.",
            failed: "Failed to apply watermark.",
        },
    },
    home: {
