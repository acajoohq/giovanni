...
export const fr: Translations = {
    ...
    watermark: {
        toolTitle: "Filigrane",
        emptyTitle: "Déposez un PDF à filigraner",
        emptyDescription: "Ajoutez une page de filigrane au-dessus ou en dessous du document.",
        sidebar: {
            files: "Fichiers",
            source: "PDF source",
        ...
        status: {
            ...
            applied_one: "Filigrane appliqué à {{count}} page.",
            applied_other: "Filigrane appliqué à {{count}} pages.",
            failed: "Échec de l'application du filigrane.",
        },
    },
    home: {
