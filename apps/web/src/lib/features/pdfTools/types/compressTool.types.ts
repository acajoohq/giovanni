...
import type { GhostscriptCompressOptions, GhostscriptPdfSettings } from "@acajoo/giovanni-core/ghostscript";
import type { QpdfOptimizePreset, WriteOptions } from "@acajoo/giovanni-core/qpdf";
