...
export function buildSplitPageEntries(
  pages: Uint8Array[],
  pattern: string,
  baseName: string
...
export async function buildJpgPageEntries(
  pages: PdfPageJpg[],
  pattern: string,
  baseName: string
...
export async function buildExtractedImageEntries(
  images: ExtractedImage[],
  baseName: string,
  options: BuildExtractedImageEntriesOptions = {}
): Promise<Record<string, Uint8Array>> {
...
export async function buildBrowserReadyImageEntries(
  images: ExtractedImage[],
  baseName: string
): Promise<Record<string, Uint8Array>> {
