import "./style.css";
import { compressPdf, getAvailableCompressionEngines, formatBytes, formatPercentage, initCompressionEngine } from "@acajoo/giovanni-core";
...
function updateSelectedFile(file: File | null) {
    ...
    selectedFileEl.textContent = file ? `${file.name} (${formatBytes(file.size)})` : "No file selected";
