export type { CombinedCompressOptions, CombinedEngineCompressOptions, CompressionEngine, CompressOptions, CompressResult, GhostscriptEngineCompressOptions, QpdfCompressOptions } from "./compression.types.js";
